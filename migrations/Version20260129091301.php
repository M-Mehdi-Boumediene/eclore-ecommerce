 ...
 */
final class Version20260129091301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_image (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) NOT NULL, product_id INT NOT NULL, color_id INT DEFAULT NULL, INDEX IDX_64617F034584665A (product_id), INDEX IDX_64617F037ADA1FB5 (color_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
